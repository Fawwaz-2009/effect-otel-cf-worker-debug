// Generated by Wrangler by running `wrangler types` (hash: 17507574a793ea108802e7962daacded)
// Runtime types generated with workerd@1.20250409.0 2025-04-10 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		OTEL_EXPORTER_OTLP_ENDPOINT: string;
		OTEL_EXPORTER_API_KEY: string;
		APP_NAME_OTL: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OTEL_EXPORTER_OTLP_ENDPOINT" | "OTEL_EXPORTER_API_KEY" | "APP_NAME_OTL">> {}
}
